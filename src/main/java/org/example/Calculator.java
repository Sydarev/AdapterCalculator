...
public class Calculator {
    ...
    public static class Formula {
        ...
        public Formula addOperand(double operand) {
            if (a == null) a = operand;
            else if (b == null) b = operand;
            else throw new IllegalStateException("Formula is full of operands");
            return this;
        }

        public Formula calculate(Operation op) {
            if (a == null || b == null) throw new IllegalStateException("Not enough operands!");
            switch (op) {
                case SUM -> result = a + b;
                case SUB -> result = a - b;
